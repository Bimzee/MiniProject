...
\title[NCIE 2015 ] % [] is optional - is placed on the bottom of the sidebar on every slide
{ % is placed on the title page
      \textbf{A LITERATURE SURVEY ON PERFORMING
      	VULNERABILITY TESTING IN WEB SERVICES}
}
...
\author[Bimal Varghese | Simi Stephen]
{      Bimal Varghese \\
      {\ttfamily bimalvv2005@gmail.com}\\
      Simi Stephen\\
      {\ttfamily simistephen@fisat.ac.in}
}
...
\begin{block}{SOA \& Web service}
  \begin{itemize}
    ...
    \item \textbf{Web Service:} Popular way of implementing a SOA.
    \item Way of Integrating web based applications using standards such as XML, SOAP, WSDL \& UDDI
    \item  To ensure quality and reliability of Web Service, proper testing  must be conducted
%    \begin{itemize}
...
\begin{block}{}
  ...
  \finalpage{\LARGE \textbf{Survey Works}}
  \end{block}
\end{frame}}
%-------------------------------------------------------
...
%	by \textbf{\textit{Lourival F de Alemeida and Silvia R Vergilio}} 
 ...
 {\1
 	\begin{frame}[plain,noframenumbering]
 		\begin{block}{}
 			...
 			\finalpage{\LARGE \textbf{Conclusion}}
 		\end{block}
 	\end{frame}}
...
%		 tested by considering SOAP message mutation approach.
